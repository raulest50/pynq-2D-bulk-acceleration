...
if __name__ == "__main__":
    ...
    # Crear un buffer para almacenar los resultados
    s = io.StringIO()

    # Crear un objeto de estadísticas y ordenar por tiempo acumulado
    sortby = 'cumulative'
    ps = pstats.Stats(pr, stream=s).sort_stats(sortby)

    # Imprimir las 10 funciones que más tiempo consumen
    ps.print_stats(10)
